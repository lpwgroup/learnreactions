...
# |                                                                    |#
# |   This code is part of LearnReactions and is covered under the     |#
# |   LearnReactions copyright notice and 3-clause BSD license.        |#
# |                                                                    |#
# |   Special note:                                                    |#
# |   This file was copied from to the forcebalance package.           |#
# |   Please make sure this file is up-to-date in                      |#
# |   both the 'learnreactions' and 'forcebalance' modules.            |#
# |                                                                    |#
